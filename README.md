...
| 기여 | 내용 |
|---|---|
| **③ 휘도·악천후 환경적응** | 밝기 5 + 악천후 3 = **8환경** RF 분류 0.972(손룰 0.47), **OOD(2차 생성기) 0.944**로 순환성 반박. 정책으로 **추론 호출 −58.5%(측정)**·캡처 100% 유지(전력 50~56% 가정 범위) |
...
| **OOD — 2차 생성기(다른 파라미터) 일반화** | **0.944** ← 순환성 반박 |
