...
| 기여 | 내용 |
|---|---|
| **③ 휘도·악천후 환경적응** | 밝기 5 + 악천후 3 = **8환경** RF 분류(15피처) 0.994(손룰 0.47), **OOD(2차 생성기) 0.956**로 순환성 반박(7/8 클래스 0.92~1.00). 정책으로 **추론 호출 −58.5%(측정)**·캡처 100% 유지 |
...
| **OOD — 2차 생성기(다른 파라미터) 일반화** | **0.956** ← 순환성 반박 (7/8 클래스 0.92~1.00) |
